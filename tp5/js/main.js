    ...
    app = new Vue({
        ...
        methods: {
            ...
            isCityExist: function (_cityName){
                ...
                if( this.cityList.filter(item => item.name.toUpperCase() == _cityName.toUpperCase()).length>0){ // JE PIGE PAAAAAAAAAS
                    return true;
                }else{
                    return false;
                }
            ...
            meteo: function (_city) {  
                ...
                this.cityWeatherLoading = true;
                    ...
                    fetch('http://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&apikey=9671f23a96b9f6a4184ddadb57a6fb3b')
